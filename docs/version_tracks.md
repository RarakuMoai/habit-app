...
最新 beta 的普通首次旅程先經語言／生日／開始前說明，再接短初見；六幕前導保留於回憶。
討論前導時須查 beta 的實際呼叫路徑。
2026-09-18 使用者已指定新旅程順序，見 [首次設定與故事方向](onboarding_preparation_v1.md)；
語言／生日與開始前說明接入 beta，按門鈴及互相取名／小事件仍待續作。
