...
class _HabitCardState extends State<HabitCard> with TickerProviderStateMixin {
  ...
  Widget _buildDailyCard() {
    ...
    // 概念版「軟糖卡」：圓角 24、無色條、打卡圈加大；完成後整張卡
    // 「洩氣」壓扁（72→52、字縮小淡化），把視覺重量讓給還沒做的事
    final minH = done ? 52.0 : 72.0;
    final circle = done ? 28.0 : 42.0;
    ...
    return Padding(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: done ? const Color(0xFFEFF7EA) : Colors.white,
          borderRadius: BorderRadius.circular(24),
          border: done
              ? Border.all(color: Colors.green.withValues(alpha: 0.16))
                      ...
                      child: done
                          ? AnimatedBuilder(
                              ...
                              builder: (_, _) => CustomPaint(
                                painter: _CheckDrawPainter(_checkAnim.value),
                              ),
                            )
                          : null,
                    ),
