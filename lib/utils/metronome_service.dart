...
class MetronomeService {
  ...
  /// 讓節拍器在靜音模式也聽得到（true→playback category，忽略實體靜音鍵）。
  /// 結束時務必傳 false 還原成 ambient，避免之後 BGM 也不再尊重靜音鍵。
  Future<void> setSilentAudible(bool audible) =>
      AppAudioSession.setLoudCategory(audible);
